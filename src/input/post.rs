...
mod tests {
    ...
    fn basic_option_string() {
        ...
        let input = post_input!(&request, { field: Option<String> }).unwrap();
    ...
    fn multiple_values_vec() {
        ...
        let input = post_input!(&request, { field: Vec<u32> }).unwrap();
    ...
    fn multiple_values_vec_parse_failure() {
        ...
        let input = post_input!(&request, { field: Vec<u8> });
    ...
    fn multiple_values_vec_option_parse_failure() {
        ...
        let input = post_input!(&request, { field: Vec<Option<u8>> }).unwrap();
    ...
    fn missing_field_vec() {
        ...
        let input = post_input!(&request, { field: Vec<String> }).unwrap();
    ...
    fn num_parse_error_option() {
        ...
        let input = post_input!(&request, { field: Option<u32> }).unwrap();
